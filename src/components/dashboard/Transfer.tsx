          ...
          {step === 1 && (
            <div>
              ...
              <div className="flex items-center justify-between gap-20">
                <Link
                  href="/dashboard"
                  className="max-w-max flex items-center justify-center rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#18819d] text-white"
                >
                  Cancel
                </Link>
                <button
                  type="button"
                  className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#18819d] text-white"
                  onClick={handleNext}
                >
                  Next
                </button>
            ...
            <div>
              <div className="mb-3">
                ...
                <div className="flex gap-2 mt-2">
                  <div className="rounded-lg flex items-center justify-center w-[35px] h-[35px] bg-[#18819d] text-white">
